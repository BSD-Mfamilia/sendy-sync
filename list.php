...
<div class="row-fluid">
    ...
    <div class="span10">
        ...
        <form class="form-search" style="float:right">
            <input type="text" name="filter" placeholder=" Filtrar por nombre" class="input-medium search-query" value="<?php echo $_GET['filter']?>"/>
            <input type="hidden" name="i" value="<?php echo get_app_info('app')?>"/>
            <button type="submit" class="btn"><i class="icon-search"></i> <?php echo _('Buscar lista');?></button>
        </form>
	    ...
	    <table class="table table-striped responsive">
		  ...
		  <tbody>
		  	...
		  	<?php 
                  ...
                  {
                      if ($nr>100) {
                          echo "<tr><td colspan=7>"._('Hay demasiadas listas para mostrar. No se muestran todas las listas. Use el filtro para buscar una lista.')."</td></tr>";
                      }
